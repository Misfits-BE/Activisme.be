...
@section('content')
    <div class="container my-4">
        {{ Breadcrumbs::render('categories-create') }}  {{-- Breadcrumb view instance --}}
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4 br-card card-shadow">
                    ...
                    <div class="card-body">
                        <form id="new-category" action="{{ route('admin.categories.store') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Naam van de categorie" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea name="description" rows="7" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="Korte beschrijving van de categorie">{{ old('description') }}</textarea>
