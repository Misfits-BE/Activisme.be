                                            ...
                                            <tr style="padding:0;text-align:left;vertical-align:top">
                                                <th style="Margin:0;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
                                                    <center data-parsed="" style="min-width:532px;width:100%"><img
                                                                class="images float-center"
                                                                src="https://www.activisme.be/img/7/conversions/thumb-image.jpg"
                                                                align="center"
                                                                style="-ms-interpolation-mode:bicubic;Margin:0 auto;border-radius:15px;clear:both;display:block;float:none;height:200px;margin:0 auto;max-width:100%;outline:0;text-align:center;text-decoration:none;width:100%">
                                                    </center>
                                                    <table class="spacer"
                                                           style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                        <tbody>
                                                    ...
                                                    <p class="lead"
                                                       style="Margin:0;Margin-bottom:10px;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:400;line-height:1.6;margin:0;margin-bottom:10px;padding:0;text-align:left">
                                                        {!! $title !!}</p>{!! $content !!}
                                                    <hr class="breakline"
                                                        style="background:#D0D0D0;border:0;color:#D0D0D0;font-size:0;height:1px;margin-bottom:5px">
                                                    <p style="Margin:0;Margin-bottom:10px;color:#0a0a0a;font-family:Helvetica,Arial,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:left">
                                                        <small style="color:#cacaca;font-size:80%">U ontvangt deze mails
                                                            omdat u bent ingeschreven op onze nieuwsbrief <a href="#"
                                                                                                             style="Margin:0;color:#2199e8;font-family:Helvetica,Arial,sans-serif;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left;text-decoration:none">klik
                                                                hier om u uit te schrijven.</a></small>
                                                    </p>
                                                </th>
                                                <th class="expander"
